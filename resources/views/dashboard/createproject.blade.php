            ...
            <ul>
                <li class="nav-item">
                    <a class="nav-link" href="./">
                        <span class="icon">
                          <img src="{{asset('assets/image/letterhead (1).png')}}" width="50" height="50" alt="" srcset="">
                        </span>
...
<form action="{{route('projectpage.store')}}" method="post" enctype="multipart/form-data">
@csrf
<div class="mb-3 mt-5 ">
...
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Content Project</label>
